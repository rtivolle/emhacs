...
- Emporia EV chargers are exposed as status sensors with attributes for charger on/off, message, and charging rate, and a power sensor that reports current charging power.
